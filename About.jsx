    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          >
            I am a passionate <span className="font-semibold text-indigo-600">Full-Stack Developer</span> with a Bachelor’s degree in Computer Applications (8.7 CGPA).
            I specialize in <span className="font-medium text-purple-600">Java, Spring Boot, ReactJS, MySQL</span>, and front-end technologies like HTML, CSS, and JavaScript.
